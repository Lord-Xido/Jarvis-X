...
This browser demonstration turns the earlier sentient-feeling interface into an observable, bounded, and testable runtime.
...
| Runtime observability | cache, ISA, ROM, neural, trace, rendering, and state metrics exposed |
...
| Testability | automated core tests plus syntax and asset checks |

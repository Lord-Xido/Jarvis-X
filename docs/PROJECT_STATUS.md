...
| Universal bitcode IR | Stable reference | `universal_bitcode.py`, CLI, corruption/budget/round-trip tests, ADR-012 | lossless typed transport and integrity only; no semantic parsing, learned compression or cross-modal generation |
